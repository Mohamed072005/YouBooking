    ...
    <table class="table align-middle mb-0 bg-white shadow">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <p class="fw-bold mb-1">john.doe@gmail.com</p>
          </td>
          <td>
            <span class="badge btn btn-success">Admin</span>
          </td>
          <td>
            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#updateUser">Modifie</button>
                        ...
                        <div class="modal-body">
                          <div class="card">
                              ...
                              <form class="row g-3">
                                  <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="text" value="John Doe" class="form-control" id="floatingName" placeholder="Your Name">
                                        <label for="floatingName">Nom Utlisateur</label>
                                    </div>
                                  </div>
                                  <div class="col-md-12">
                                    <div class="form-floating">
                                        <input type="email" value="john.doe@gmail.com" class="form-control" id="floatingName" placeholder="Your Name">
                                        <label for="floatingName" >Email</label>
                                    </div>
                                  </div>
                                  <div class="col-md-12">
